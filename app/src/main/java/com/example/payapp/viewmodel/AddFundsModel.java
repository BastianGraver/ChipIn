package com.example.payapp.viewmodel;
...
import com.example.payapp.util.PaymentsUtil;

public class AddFundsModel extends AndroidViewModel {
    ...
    public AddFundsModel(@NonNull Application application) {
        super(application);
    ...
    public Task<PaymentData> getLoadPaymentDataTask(final long priceCents) {
        ...
        Log.d("Bastian", "getLoadPaymentDataTask: init");
        if (paymentDataRequestJson == null) {
            Log.d("Bastian", "getLoadPaymentDataTask: Is null");
            return null;
        }

        PaymentDataRequest request =
                PaymentDataRequest.fromJson(paymentDataRequestJson.toString());
        Log.d("Bastian", "getLoadPaymentDataTask: " + paymentsClient.loadPaymentData(request).toString());
